...
import { searchCatalog, TIER_META } from "@/lib/courses";
...
export function CatalogSearch({
  placeholder = "Type a cake name — Bento, Medovik, Croissant…",
  size = "lg",
  autoFocus,
}: Props) {
        ...
        <div className="absolute left-0 right-0 top-full z-50 mt-2 overflow-hidden rounded-2xl border border-border bg-card shadow-[var(--shadow-warm)] animate-in fade-in slide-in-from-top-1">
          {hits.length === 0 ? (
            <p className="p-5 text-sm text-muted-foreground">
              No lesson matches “{q}”. Try Bento, Medovik, Cinnamon, or San Sebastian.
            </p>
          ) : (
